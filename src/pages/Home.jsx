...
const Home = () => {
    ...
    return (
        <div>
            ...
            <div className="max-w-[1920px] mt-20  mx-auto relative overflow-hidden">
                ...
                <div className="coffeeContainer  mb-10">
                    {/* Section Head */}
                    ...
                    <div className="grid lg:grid-cols-2 gap-4 mt-10">
                        {
                            items.length === 0 && <p className="text-center font-rancho text-[30px] text-[#331A15]">No Coffee Found</p>
                        }
                        {
                            items?.map((item) => (
                                <ProductsCard items={items} setItems={setItems} key={item._id} item={item} />
                            ))
                        }
                        {/* <ProductsCard />
                        <ProductsCard />
