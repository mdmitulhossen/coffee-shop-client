            ...
            <div className="max-w-[1920px] mx-auto relative">
                ...
                <div className="coffeeContainer mt-20 mb-10">
                    ...
                    <div className="w-full text-center">
                        ...
                        <button className="bg-[#E3B577] px-4 py-1 font-rancho text-white flex justify-center items-center gap-2 mx-auto hover:bg-[#F5F4F1] hover:text-[#331A15] duration-150">
                            Add Coffee
