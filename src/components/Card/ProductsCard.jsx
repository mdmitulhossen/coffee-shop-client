...
const ProductsCard = ({ item, items, setItems }) => {
    ...
    return (
        <div className="bg-[#F5F4F1] w-full py-2 pl-2 pr-8 rounded-lg">
            <div className='flex justify-between items-center'>
                ...
                <div className='space-y-2 md:text-2xl lg:text-base 2xl:text-lg min-[1600px]:text-2xl'>
                    ...
                    <p className='font-raleway text-[#1B1A1A] font-medium'>Price : <span className='text-[#5C5B5B]'>{price} Taka</span></p>
                </div>
                <div className='flex flex-col gap-3 '>
                    {/* view */}
                    <span onClick={() => navigate(`/coffee/details/${_id}`)} className='inline-block p-2 bg-[#D2B48C] rounded cursor-pointer'>
                    ...
                    {/* Edit */}
                    <span onClick={() => navigate(`/coffee/update/${_id}`)} className='inline-block p-2 bg-[#3C393B] rounded cursor-pointer'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    ...
                    {/* Delete */}
                    <span onClick={handleItemsDelete} className='inline-block p-2 bg-[#EA4744] rounded cursor-pointer'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
